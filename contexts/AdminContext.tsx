...
const defaultContent: Record<string, string> = {
  ...
  'trainer-3-name': 'Arthur',
  'trainer-3-role': 'Treinador',
  'trainer-3-bio': 'Referência em treinamento resistido e dinâmicas de grupo. Arthur comanda as aulas de JUMP e Stepdance com energia, focando em coordenação motora e intensidade.',
  'trainer-3-img': 'https://images.unsplash.com/photo-1599058945522-28d584b6f0ff?q=80&w=2069&auto=format&fit=crop',
  'trainer-4-name': 'Mateus Salomon',
  'trainer-4-role': 'Treinador',
  'trainer-4-bio': 'Especialista em Funcionalidade e Spinning. Seus treinos focam em movimento inteligente para o dia a dia e condicionamento cardiovascular intenso na bike.',
  'trainer-4-img': 'https://images.unsplash.com/photo-1518611012118-696072aa579a?q=80&w=2070&auto=format&fit=crop',
  'trainer-5-name': 'Taynan',
  'trainer-5-role': 'Treinador',
  'trainer-5-bio': 'Focado em musculação para atletas. Taynan aplica técnicas avançadas do fisiculturismo para maximizar a hipertrofia e a performance de quem busca resultados de atleta.',
  'trainer-5-img': 'https://images.unsplash.com/photo-1534438327276-14e5300c3a48?q=80&w=2070&auto=format&fit=crop',
  'trainer-6-name': 'Igor Veloso',
  'trainer-6-role': 'Treinador',
  'trainer-6-bio': 'Uma combinação técnica de força e controle. Igor é focado em treinos para atletas de musculação e também especialista no método Mat Pilates para estabilidade e core.',
  'trainer-6-img': 'https://images.unsplash.com/photo-1504609773096-104ff2c73ba4?q=80&w=2070&auto=format&fit=crop',
  'trainer-7-name': 'Amanda',
  'trainer-7-role': 'Treinadora',
  'trainer-7-bio': 'Focada no treinamento feminino, entendendo as necessidades específicas do corpo da mulher. Além disso, lidera aulas de Spinning vibrantes e motivadoras.',
