...
const defaultContent: Record<string, string> = {
  ...
  // Trainers Section
  'trainers-title': 'Nosso Time',
  'trainers-subtitle': 'Profissionais apaixonados, qualificados e prontos para te levar ao próximo nível.',
  'trainer-1-name': 'Coach Alex',
  'trainer-1-role': 'Head Coach & Musculação',
  'trainer-1-bio': 'Especialista em biomecânica e hipertrofia. Com 10 anos de experiência, Alex lidera a equipe técnica da Oasis garantindo que cada aluno execute os movimentos com perfeição.',
  'trainer-1-img': 'https://images.unsplash.com/photo-1567013127542-490d757e51fc?q=80&w=1887&auto=format&fit=crop',
  'trainer-2-name': 'Treinadora Júlia',
  'trainer-2-role': 'Spinning & Cardio',
  'trainer-2-bio': 'Energia pura! As aulas da Júlia são conhecidas pela intensidade e playlists motivadoras. Especialista em condicionamento físico e emagrecimento.',
  'trainer-2-img': 'https://images.unsplash.com/photo-1611672585731-fa1060a7a3c2?q=80&w=1887&auto=format&fit=crop',
  'trainer-3-name': 'Mestre Ricardo',
  'trainer-3-role': 'Artes Marciais',
  'trainer-3-bio': 'Faixa preta em Jiu-Jitsu e ex-atleta profissional. Ricardo traz disciplina e técnica refinada para o tatame, ensinando defesa pessoal e respeito.',
  'trainer-3-img': 'https://images.unsplash.com/photo-1599058945522-28d584b6f0ff?q=80&w=2069&auto=format&fit=crop',
  'trainer-4-name': 'Profa. Amanda',
  'trainer-4-role': 'Pilates & Mobilidade',
  'trainer-4-bio': 'Fisioterapeuta de formação, Amanda foca na saúde da coluna, correção postural e fortalecimento do core através do método Pilates.',
  'trainer-4-img': 'https://images.unsplash.com/photo-1518611012118-696072aa579a?q=80&w=2070&auto=format&fit=crop',
  'trainer-5-name': 'Coach Bruno',
  'trainer-5-role': 'Cross Training',
  'trainer-5-bio': 'Certificado em LPO e Ginástica. Bruno desafia seus limites com treinos funcionais de alta intensidade, focando em potência e agilidade.',
  'trainer-5-img': 'https://images.unsplash.com/photo-1534438327276-14e5300c3a48?q=80&w=2070&auto=format&fit=crop',
  'trainer-6-name': 'Treinadora Carla',
  'trainer-6-role': 'Dança & Ritmos',
  'trainer-6-bio': 'Bailarina profissional que traz a técnica da dança para o fitness. Suas aulas de Stepdance e FitDance são uma festa que queima calorias.',
  'trainer-6-img': 'https://images.unsplash.com/photo-1504609773096-104ff2c73ba4?q=80&w=2070&auto=format&fit=crop',
  'trainer-7-name': 'Instrutor Pedro',
  'trainer-7-role': 'Natação & Kids',
  'trainer-7-bio': 'Com uma metodologia lúdica e paciente, Pedro é o favorito das crianças. Especialista em natação infantil e desenvolvimento motor aquático.',
  'trainer-7-img': 'https://images.unsplash.com/photo-1530549387789-4c1017266635?q=80&w=2070&auto=format&fit=crop',
};
